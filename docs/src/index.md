...
[Plot options](@ref) lists the keyword arguments every recipe accepts, for the figure and
its watermarks. The [Recipes](@ref "Histograms") pages show every recipe on data built from
